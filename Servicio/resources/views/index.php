				...
				<div class="container">					
					<div class="navbar-header">
						...
						<div class="navbar-brand">
							<a href="index.html"><h1><span>Servico</span>Técnico</h1></a>
						</div>
					</div>
					...
					<div class="navbar-collapse collapse">							
						<div class="menu">
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation"><a href="blog.html">FAQ</a></li>
	...
	<section id="partner">
        <div class="container">
            <div class="center wow fadeInDown">
                ...
                <p>Somos parte de una gama de marcas, las cuales reciben el apoyo.<br> Siempre listos para atenderte.</p>
            </div>    
